This project is based on the Serial Traffic Generator from 4RF, modified to test a connection between a serial port and a TCP connection to the same machine.

# Serial to TCP Traffic Generator
This is a tool for testing the performance a serial link to tcp connection to the same machine. You can make the following measurements:
* Throughput
* Latency
* Poll response latency

You can fix the bandwidth of sending
